...
| ------------------                        |                            | ---                                      |                    |                    |                                           | ------------------                        | ----------------               | ---    |
| ------------------                        |                            |                                          |                    |                    | ----------------------------------------- |                                           |
| `--local-model`                           | Local                      |                                          | Hugging            |                    | Face model name                           |
| `HuggingFaceTB/SmolLM3-3B`                |                            |                                          |                    |                    |                                           | `--local-model microsoft/DialoGPT-medium` |
|                                           | `--model-endpoint`         |                                          |                    |                    |                                           |                                           | OpenAI-compatible API endpoint | `None` |     |     |
