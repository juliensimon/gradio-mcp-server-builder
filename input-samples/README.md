...
1. _priority(task_ids, priority)\`\*\* - Batch priority updates
1. s_by_date(date_filter, days)\`\*\* - Date-based filtering
1. by_criteria(criteria, value)\`\*\* - Counting operations
1. leted_tasks(days_old)\`\*\* - Data cleanup
