...
def setup_logging(config_path: str = "log_config.json", log_file: str = "output.log") -> None:
    """
    ...
    if config_file.exists():
        ...
        logging.warning(f"Logging config file {config_path} not found. Using default configuration.")
    ...
    for handler_name, handler_config in handlers.items():
        if handler_config.get("class") in [
            ...
            if "gradio_mcp_builder.log" in current_filename:
                ...
                handler_config["filename"] = log_file
            elif current_filename in ["gradio_mcp_builder_errors.log", "errors.log", "error.log"]:
