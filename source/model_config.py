...
class ModelConfigLoader:
    ...
    def load_config(self) -> ModelConfig:
        ...
        try:
            ...
            self.logger.info(
                f"Successfully loaded model config from {self.config_path}"
            )
            return self._config
    ...
    def _parse_config(self, config_data: Dict[str, Any]) -> ModelConfig:
        ...
        performance = PerformanceConfig(
            ...
            attention_implementation=config_data["performance"][
    ...
    def _create_default_config(self) -> ModelConfig:
        ...
        api_model = ApiModelConfig(
            ...
            generation_params={"max_tokens": 200, "temperature": 0.7, "top_p": 0.9},
            request_params={"timeout": 30, "max_retries": 3, "retry_delay": 1.0},
        )
    ...
    def format_prompt(self, prompt_type: str, **kwargs) -> str:
        ...
        try:
            ...
            self.logger.debug(
                f"Formatted {prompt_type} prompt (length: {len(formatted)})"
            )
            return formatted
