...
class TestConfig:
    ...
    def test_config_model_config_paths(self):
        ...
        # Test custom path
        config_custom = Config(input_files=input_files, model_config="custom/path/config.json")
    ...
    def test_config_validation_methods(self):
        ...
        config_remote = Config(input_files=input_files, model_endpoint="http://example.com")
